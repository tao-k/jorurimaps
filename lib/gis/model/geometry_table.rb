# encoding: utf-8
module Gis::Model::GeometryTable


  def self.included(mod)
    #mod.table_name = mod.to_s.underscore.gsub('/', '_').downcase.pluralize
    #mod.table_name = self.table_name

    mod.before_save :after_validation
  end

  def self.new(gis_table_name)
    #self.table_name = gis_table_name
    #self.before_save :after_validation
    #mod.table_name = gis_table_name
  end

  #def self.initialize(gis_table_name)
  #  self.table_name = gis_table_name
  #  self.before_save :after_validation
  #end
